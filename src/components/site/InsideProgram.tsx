...
const features: Feature[] = [
  {
    Icon: Layers,
    title: "2 специалиста в одном дипломе",
  ...
  {
    Icon: Building2,
    title: "Доступ к индустриальному партнеру",
  ...
  },
  {
    ...
    desc: "Вычислительные кластеры, GPU-серверы и облачные платформы для обучения моделей.",
    details: [
